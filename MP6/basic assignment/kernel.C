   ...
   // unsigned char buftest[512];
    ...
    for(int j = 0;; j++) {
       ...
       /* -- Read */
        ...
        Console::puts("write_block is "); Console::puti(write_block); Console::puts("\n");
        */


       Console::puts("Reading a block from disk...\n");
       SYSTEM_DISK->read(read_block, buf);
       Console::puts("read_block is "); Console::puti(read_block); Console::puts("\n");
        int i;
       for (i = 0; i < 512; i++)
           Console::puti(buf[i]);
       ...
       Console::puts("\n");
       /*{
         Console::puts("buf[ ");Console::puti(i);Console::puts(" ]=  ");Console::puti(buf[i]);Console::puts(" ");
         // Console::putch(buf[i]); Console::puts("\n");
       }
       Console::puts("\n"); */
       Console::puts("Output is completed "); Console::puts("\n");
       ...
       write_block = read_block;  //(write_block + 1)%20;
